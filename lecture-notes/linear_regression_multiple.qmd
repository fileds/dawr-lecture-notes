...
```{r}
# Model fitted by explicitly listing the predictor, dropping missing values
# first
...
model_bs2 <- birth |> lm(
    formula = birth_weight_g ~ pregnancy_duration_wks + sex + weight_kg + bmi
)
prediction2 <- predict(
  model_bs2,
  data.frame(
