...
recreate_valjarbarometern <- function(valjarbarometern_aggregate, n)
{
  ...
  party_observations <- mapply(
      rep,
      valjarbarometern_aggregate$party,
      obs_per_party
  )
...
```{r}
# Define the colors in the order V, S, MP, C, L, KD, M, SD, Other. Make sure
# party column follows the same order!
party_colors <- c(
    "#800000",  # V
    "#FF0000",  # S
    "#90EE90",  # MP
...
# Conducting hypothesis test of proportions. Observe that we are testing if
