...
Multiple imputation is the most popular imputation. It consists of sampling from the distribution of observed values to create new dataset. It is a conceptually more difficult method, but if you are interested you can have a look at the [mice package](https://cran.r-project.org/web/packages/mice/index.html) in R.
